  ...
  async create(input: EndpointCreateInput): Promise<DatabaseEndpoint> {
    const [createdEndpoint] = await db
      ...
      .values({
        ...
        enable_smart_mode: input.enable_smart_mode ?? false,
        search_mode: input.search_mode ?? 'keyword',
  ...
  async findAll(): Promise<DatabaseEndpoint[]> {
    return await db
      .select({
        ...
        enable_smart_mode: endpointsTable.enable_smart_mode,
        search_mode: endpointsTable.search_mode,
  ...
  async update(input: EndpointUpdateInput): Promise<DatabaseEndpoint> {
    const [updatedEndpoint] = await db
      ...
      .set({
        ...
        enable_smart_mode: input.enable_smart_mode,
