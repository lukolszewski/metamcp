...
<AccordionGroup>
  <Accordion icon="github" title="Fork and Clone">
    ...
    3. **Add upstream remote**:
       ```bash
       git remote add upstream https://github.com/lukolszewski/metamcp.git
       ```
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/lukolszewski/metamcp/issues">
...
<CardGroup cols={1}>
  <Card title="Start Contributing" icon="rocket" href="https://github.com/lukolszewski/metamcp/issues">
