...
> **Implementation Reference**: The authentication logic described in this page is implemented in [`apps/backend/src/middleware/api-key-oauth.middleware.ts`](https://github.com/lukolszewski/metamcp/blob/main/apps/backend/src/middleware/api-key-oauth.middleware.ts).
