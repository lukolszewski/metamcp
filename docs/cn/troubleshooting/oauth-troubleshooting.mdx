...
> **实现参考**: 本页面描述的身份验证逻辑在 [`apps/backend/src/middleware/api-key-oauth.middleware.ts`](https://github.com/lukolszewski/metamcp/blob/main/apps/backend/src/middleware/api-key-oauth.middleware.ts) 中实现。
